...
- session id: `goal_round02_mpox_drc_2024_08`
- live search: `True`
- live fetch: `True`
- LLM stages: `True`
...
| final_dataset_pre_quality_gate_count | 35 |
| zero_case_statement_count | 0 |
| exposure_monitoring_record_count | 2 |
| surveillance_summary_record_count | 26 |
| outbreak_summary_record_count | 6 |
| context_record_count | 11 |
...
- source verification chain: predicted=1, discovered=1, fetched=1, fetch_failed=1, parsed=1, unusable=1, chunks=1213, records=35, extracted=1, accepted=1
- official_extraction_failure_reasons: `{'must_fetch_source_partially_skipped_due_to_chunk_cap': 8, 'must_fetch_source_not_attempted_for_extraction': 5}`
...
- surveillance_summary_records: 26 条。surveillance summary 可能是 aggregate，不一定是 individual case record。
- outbreak_summary_records: 6 条。outbreak summary 可能是 aggregate 或 outside requested scope。
- context_records: 11 条。context/background evidence 有背景价值，但不是 case count。
- unclassified_observation_records: 5 条。unclassified observation 需要人工判断。
- non_primary_observations: 13 条。non-primary observations 保留为非主病例证据视图。

## 6. 跨来源印证结果

- claim_count: `40`
- claim_comparison_count: `780`
- corroborated_event_count: `12`
- corroborated_primary_case_event_count: `0`
- conflicting_claim_count: `10`
...
- fetched_document_count: `26`
- source_identity_assessed_count: `29`
- actual_publisher_unknown_count: `16`
- source_type_counts: `{'unknown': 13, 'international_public_health_agency': 6, 'national_public_health_agency': 1, 'social_media': 2, 'structured_database': 1, 'official_public_health_agency': 6}`
...
- review_source_credibility_src_search_525c0a51cb88: disease_relevant_but_location_unclear; missing_publisher
- review_source_src_search_525c0a51cb88: Source classified as data_source; both screening and critic agree to include for content fetch.
- review_source_credibility_src_search_9befc0a97780: missing_publisher
- review_source_src_search_9befc0a97780: Source classified as data_source; both screening and critic agree to include for content fetch.
- review_source_credibility_src_search_b0d9edeca9ff: disease_relevant_but_location_unclear; missing_publisher
