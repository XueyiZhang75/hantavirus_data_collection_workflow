...
- session id: `goal_round06_legionnaires_ontario_2025_07`
- live search: `True`
- live fetch: `True`
- LLM stages: `True`
...
| final_dataset_pre_quality_gate_count | 22 |
| zero_case_statement_count | 3 |
| exposure_monitoring_record_count | 0 |
| surveillance_summary_record_count | 4 |
| outbreak_summary_record_count | 1 |
| context_record_count | 4 |
| unclassified_observation_count | 19 |
| non_primary_observation_count | 7 |
| quarantined_record_count | 3 |
| pending_review_record_count | 19 |
...
- source verification chain: predicted=1, discovered=1, fetched=1, fetch_failed=0, parsed=1, unusable=1, chunks=203, records=22, extracted=1, accepted=0
- failure_stage: `records_quarantined`.
- official_extraction_failure_reasons: `{'must_fetch_source_partially_skipped_due_to_chunk_cap': 6, 'must_fetch_source_not_attempted_for_extraction': 3, 'must_fetch_source_produced_no_records': 2}`
...
- zero-case statements: 3. These are useful public-health observations but not confirmed cases unless separately accepted as primary case records.
- surveillance summaries: 4. These are useful public-health observations but not confirmed cases unless separately accepted as primary case records.
...
- unclassified observations: 19. These are useful public-health observations but not confirmed cases unless separately accepted as primary case records.
...
- claim_count: `24`
- claim_comparison_count: `276`
- corroborated_event_count: `4`
- corroborated_primary_case_event_count: `0`
- conflicting_claim_count: `14`
...
- source_candidate_count: `37`
- fetched_document_count: `22`
- source_identity_assessed_count: `37`
- actual_publisher_unknown_count: `34`
- source_type_counts: `{'official_public_health_agency': 12, 'social_media': 5, 'news_media': 11, 'structured_database': 1, 'unknown': 6, 'secondary_aggregator': 1, 'national_public_health_agency': 1}`
...
- review_source_credibility_src_search_a828b4a066a7: missing_publisher
- review_source_src_search_a828b4a066a7: Source classified as data_source; both screening and critic agree to include for content fetch.
- review_source_credibility_src_search_610d6ac3f5c7: missing_publisher
- review_source_src_search_610d6ac3f5c7: Source classified as data_source; both screening and critic agree to include for content fetch.
- review_source_credibility_src_search_219b6b429550: missing_publisher
