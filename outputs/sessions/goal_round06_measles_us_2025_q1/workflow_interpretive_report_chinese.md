...
- surveillance_summary_records: 3 条。surveillance summary 可能是 aggregate，不一定是 individual case record。
- outbreak_summary_records: 7 条。outbreak summary 可能是 aggregate 或 outside requested scope。
- context_records: 6 条。context/background evidence 有背景价值，但不是 case count。
- unclassified_observation_records: 7 条。unclassified observation 需要人工判断。
