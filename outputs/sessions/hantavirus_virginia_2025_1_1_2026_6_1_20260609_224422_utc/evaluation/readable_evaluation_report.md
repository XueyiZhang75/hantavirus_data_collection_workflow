...
- Rows with collection evidence: 0
- Rows with validation evidence: 0
- Rows with both collection and validation evidence: 0
- Masking compliance summary: none
- Human review flagged row count: 0
...
- Validation compatibility warnings: geography_mismatch: geography mismatch; no task-compatible held-out validation source is active

## Evaluation Status Counts

- Overall match status counts: none
- Masking compliance status counts: none
- Provenance completeness status counts: none
