...
- Session: `goal_round03_west_nile_california_2024_08`
...
|---:|---|---|---|---|
| 1 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_008 - West Nile Virus Maps Show Cas... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 2 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_015 - California West Nile Virus We... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 3 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_019 - Westnile.ca.gov / California... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 4 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_020 - [PDF] WEEKLY UPDATE - Califor... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 5 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_035 - West Nile virus, spread by mo... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
...
| 7 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_normalization_rec_src_search_1901d64d67f4_009 - [... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 8 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_normalization_rec_src_search_29301bcfe202_002 - W... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 9 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_normalization_rec_src_search_c0d70a141aca_002 - W... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 10 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_normalization_rec_src_search_fc3322f3069f_001 - C... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
