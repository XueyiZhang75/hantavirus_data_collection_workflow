...
- Session: `goal_round05_west_nile_california_2024_08`
...
- Review items in queue: `130`
- Prioritized items generated: `130`
...
| 2 | P0_critical | conflicting_claims_review | conflicting claims review - review_claim_corroboration_conflict_corr_event_004 - West N... | review_claim_corroboration |
| 3 | P0_critical | conflicting_claims_review | conflicting claims review - review_claim_corroboration_conflict_corr_event_005 - West N... | review_claim_corroboration |
| 4 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_011 - What to know about West Nile... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 5 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_012 - 3 cases of West Nile Virus co... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 6 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_014 - California West Nile Virus We... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 7 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_015 - California West Nile Virus We... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 8 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_016 - What to know about West Nile... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 9 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_023 - 3 cases of West Nile Virus co... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
| 10 | P0_critical | primary_case_dataset_blocker | primary case dataset blocker - review_linking_event_027 - West Nile virus, spread by mo... | Inspect the record, evidence quote, source identity, and quality-gate reasons before ed... |
