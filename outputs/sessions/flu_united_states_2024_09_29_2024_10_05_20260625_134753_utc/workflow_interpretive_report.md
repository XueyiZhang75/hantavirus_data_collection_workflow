...
- session id: `flu_united_states_2024_09_29_2024_10_05_20260625_134753_utc`
- live search: `True`
- live fetch: `True`
- LLM stages: `True`
...
| non_primary_observation_count | 6 |
...
- source verification chain: predicted=1, discovered=1, fetched=1, fetch_failed=0, parsed=1, unusable=0, chunks=162, records=13, extracted=1, accepted=1
...
- non-primary observations: 6. These are useful public-health observations but not confirmed cases unless separately accepted as primary case records.
...
- fetched_document_count: `8`
- source_identity_assessed_count: `36`
- actual_publisher_unknown_count: `15`
- source_type_counts: `{'national_public_health_agency': 10, 'official_public_health_agency': 10, 'social_media': 1, 'international_public_health_agency': 6, 'state_or_local_public_health_agency': 3, 'secondary_aggregator': 1, 'academic_or_peer_reviewed_source': 1, 'news_media': 4}`
...
- review_source_src_search_e47861556720: Screening and critic disagree on this source; routing to human review for resolution.
