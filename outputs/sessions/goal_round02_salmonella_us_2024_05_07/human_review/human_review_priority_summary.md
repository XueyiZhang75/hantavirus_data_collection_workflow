...
- Session: `goal_round02_salmonella_us_2024_05_07`
...
|---:|---|---|---|---|
| 1 | P0_critical | conflicting_claims_review | conflicting claims review - review_claim_corroboration_conflict_corr_event_001 - Ongoin... | review_claim_corroboration |
| 2 | P0_critical | validation_conflict_review | validation conflict review - review_anomaly_anom_005 - Outbreak Investigation of Salmon... | resolve_validation_conflict |
| 3 | P0_critical | claim_corroboration_review | claim corroboration review - review_anomaly_anom_003 - Outbreak Investigation of Salmon... | confirm_scope_or_reject_record |
| 4 | P0_critical | claim_corroboration_review | claim corroboration review - review_anomaly_anom_004 - Outbreak Investigation of Salmon... | confirm_scope_or_reject_record |
| 5 | P1_high | validation_conflict_review | validation conflict review - review_duplicate_event_001 - Cucumber outbreak from salmon... | Inspect the linked artifacts and only then edit a decision file if needed. |
| 6 | P1_high | claim_corroboration_review | claim corroboration review - review_claim_corroboration_review_corr_event_002 - 2024 Sa... | review_claim_corroboration |
| 7 | P1_high | claim_corroboration_review | claim corroboration review - review_claim_corroboration_review_corr_event_003 - CDC end... | review_claim_corroboration |
| 8 | P1_high | claim_corroboration_review | claim corroboration review - review_claim_corroboration_review_corr_event_004 - CDC end... | review_claim_corroboration |
| 9 | P1_high | claim_corroboration_review | claim corroboration review - review_claim_corroboration_review_corr_event_005 - CDC end... | review_claim_corroboration |
| 10 | P1_high | claim_corroboration_review | claim corroboration review - review_claim_corroboration_review_corr_event_006 - CDC end... | review_claim_corroboration |
