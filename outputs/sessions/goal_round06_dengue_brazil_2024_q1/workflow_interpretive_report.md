...
- session id: `goal_round06_dengue_brazil_2024_q1`
- live search: `True`
- live fetch: `True`
- LLM stages: `True`
...
- source verification chain: predicted=1, discovered=1, fetched=1, fetch_failed=0, parsed=1, unusable=1, chunks=388, records=18, extracted=1, accepted=0
- failure_stage: `records_quarantined`.
- official_extraction_failure_reasons: `{'must_fetch_source_partially_skipped_due_to_chunk_cap': 13, 'must_fetch_source_not_attempted_for_extraction': 11, 'must_fetch_source_produced_no_records': 1}`
...
- surveillance summaries: 9. These are useful public-health observations but not confirmed cases unless separately accepted as primary case records.
...
- context/background records: 15. These are useful public-health observations but not confirmed cases unless separately accepted as primary case records.
...
- non-primary observations: 11. These are useful public-health observations but not confirmed cases unless separately accepted as primary case records.
...
- conflicting_claim_count: `4`
- single_source_unverified_count: `4`
...
- fetched_document_count: `38`
- source_identity_assessed_count: `48`
- actual_publisher_unknown_count: `39`
- source_type_counts: `{'official_public_health_agency': 16, 'unknown': 12, 'international_public_health_agency': 7, 'structured_database': 1, 'news_media': 6, 'social_media': 2, 'secondary_aggregator': 3, 'background_fact_sheet': 1}`
...
- human_review_item_count: `81`
- Review source scope mismatch, validation limitation, publisher uncertainty, and single-source unverified claims first.
- review_source_credibility_src_search_5fd7d33501e8: disease_relevant_but_location_unclear; missing_publisher
- review_source_src_search_5fd7d33501e8: Source classified as data_source; both screening and critic agree to include for content fetch.
