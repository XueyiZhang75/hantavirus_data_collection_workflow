...
- exposure_monitoring_records: 1 条。exposure monitoring 不是 confirmed/probable/suspected case record。
- surveillance_summary_records: 9 条。surveillance summary 可能是 aggregate，不一定是 individual case record。
...
- non_primary_observations: 11 条。non-primary observations 保留为非主病例证据视图。
