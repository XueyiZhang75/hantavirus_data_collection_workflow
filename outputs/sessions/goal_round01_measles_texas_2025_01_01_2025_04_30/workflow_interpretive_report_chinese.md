...
本次 workflow 产生了 6 条通过质量门的 primary case dataset records；这些记录仍需结合来源身份、跨源印证状态和人工审核结果判断是否适合最终使用。
...
- non_primary_observations: 3 条。non-primary observations 保留为非主病例证据视图。
