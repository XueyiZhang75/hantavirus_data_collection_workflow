...
- session id: `goal_round08_dengue_brazil_2024_q1`
- live search: `True`
- live fetch: `True`
- LLM stages: `True`
...
| final_dataset_pre_quality_gate_count | 26 |
...
| non_primary_observation_count | 5 |
| quarantined_record_count | 11 |
| pending_review_record_count | 15 |
...
- source verification chain: predicted=1, discovered=1, fetched=1, fetch_failed=1, parsed=1, unusable=1, chunks=401, records=27, extracted=1, accepted=0
- failure_stage: `records_quarantined`.
- official_extraction_failure_reasons: `{'must_fetch_source_partially_skipped_due_to_chunk_cap': 14, 'must_fetch_source_not_attempted_for_extraction': 8}`
...
- non-primary observations: 5. These are useful public-health observations but not confirmed cases unless separately accepted as primary case records.
...
- source_type_counts: `{'official_public_health_agency': 14, 'social_media': 4, 'structured_database': 2, 'unknown': 8, 'international_public_health_agency': 9, 'secondary_aggregator': 3, 'news_media': 4}`
...
- review_source_credibility_src_search_8a863e6c52f9: disease_relevant_but_location_unclear; missing_publisher
- review_source_src_search_8a863e6c52f9: Source classified as data_source; both screening and critic agree to include for content fetch.
- review_source_credibility_src_search_9f1bffa1139f: disease_relevant_but_location_unclear; missing_publisher
